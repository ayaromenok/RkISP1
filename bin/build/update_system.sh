...
sudo apt install v4l-utils libncurses-dev libgstreamer1.0-dev libdrm-dev libgstreamer-plugins-base1.0-dev libgstreamer-plugins-good1.0-dev autopoint autotools-dev libtool-bin libxrandr-dev gstreamer1.0-tools bc -y
